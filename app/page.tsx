...
export default function Home() {
  return (
    <section className="flex flex-col gap-10 max-w-4xl bg-black-400 p-5 rounded-md border-cherry_light-800 border-2">
      ...
      <div className="flex flex-col gap-2">
        <p className="text-lg font-bold text-center italic">What can Chaery do for you and your partner?</p>
        <p className="text-md">
          Chaery simplifies all the complexities of planning your lives together. From managing your finances to
          planning your next date night, Chaery has you covered.
        </p>
        <div>
